package com.rpg.service.sistema;

import com.rpg.model.inimigo.BossFinal;
import com.rpg.model.inimigo.Inimigo;
import com.rpg.model.item.Item;
import com.rpg.model.personagem.Personagem;
import com.rpg.service.save.SaveManager;
...
public class Combate {
    ...
    public boolean iniciar(Personagem jogador, Inimigo inimigo) {
        ...
        while (jogador.estaVivo() && inimigo.estaVivo()) {
            ...
            System.out.println("HP   " + criarBarra(jogador.getVida(), jogador.getVidaMax()) + " " + jogador.getVida() + "/" + jogador.getVidaMax());
            System.out.println("Mana " + criarBarra(jogador.getMana(), jogador.getManaMax()) + " " + jogador.getMana() + "/" + jogador.getManaMax());
            System.out.println();
            System.out.println(inimigo.getNome());
            System.out.println("HP   " + criarBarra(inimigo.getVida(), inimigo.getVidaMax()) + " " + inimigo.getVida() + "/" + inimigo.getVidaMax());
            System.out.println("====================");
