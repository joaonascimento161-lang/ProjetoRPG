...
public class TelaPrincipal extends JFrame {
    ...
    public TelaPrincipal(Personagem jogador){
        ...
        btnFloresta.setBackground(Color.GREEN);
        btnFloresta.setForeground(Color.BLACK);

        btnCaverna.setBackground(Color.DARK_GRAY);
        btnCaverna.setForeground(Color.WHITE);

        btnRuinas.setBackground(Color.LIGHT_GRAY);
        btnRuinas.setForeground(Color.BLACK);

        JPanel painelAreas = new JPanel(new FlowLayout(FlowLayout.CENTER));
