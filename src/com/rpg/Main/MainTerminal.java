...
import com.rpg.model.inimigo.*;
import com.rpg.model.inimigo.ReiGoblin;
import com.rpg.model.item.Item;
import com.rpg.service.save.*;
import com.rpg.service.sistema.*;
...
public class MainTerminal {
    ...
    private static void novoJogo(){
        ...
        com.rpg.model.personagem.Personagem jogador = escolherClasse();
    ...
    private static void continaurJogo(){
        ...
        com.rpg.model.personagem.Personagem jogador = SaveManager.carregar();
    ...
    private static com.rpg.model.personagem.Personagem escolherClasse(){
    ...
    private static void menuAreas(com.rpg.model.personagem.Personagem jogador){
    ...
    private static void iniciarArea(com.rpg.model.personagem.Personagem jogador, int Area){
        ...
        com.rpg.model.inimigo.Inimigo inimigo = null;
    ...
    private static void abrirInventario(com.rpg.model.personagem.Personagem jogador){
    ...
    private static boolean areaLiberada(com.rpg.model.personagem.Personagem jogador, int area){
        switch (area) {
            case 1:
